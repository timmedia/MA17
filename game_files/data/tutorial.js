...
Game.tutorial.prototype.create = function() {
...
Game.tutorial.prototype.update = function() {
...
Game.tutorial.prototype.doorAction = function() {
  this.state.start('main_menu');
}

Game.tutorial.prototype.buttonPress = function() {
  if(!this.key.visible) {this.key.visible = true;}
}

Game.tutorial.prototype.openBubble = function(n) {
...
Game.tutorial.prototype.closeBubble = function() {
  this.add.tween(this.speechbubble.scale).to({x: 0, y: 0}, 200, Phaser.Easing.Quadratic.InOut, true);
}

Game.tutorial.prototype.michaelCheck = function() {
  switch (this.speechbubble.frame) {
    ...
    case 2:
      if (!this.speechbubble.busy) {
        this.physics.arcade.overlap(this.door, this.player, function() {
          this.time.events.add(2000, this.closeBubble, this);
          this.speechbubble.busy = true;
    ...
    case 3:
      if (!this.speechbubble.busy) {
        this.physics.arcade.overlap(this.button, this.player, function() {
          this.time.events.add(2000, this.closeBubble, this);
          this.speechbubble.busy = true;
...
Game.tutorial.prototype.collectKey = function() {
  this.door.unlock();
  this.key.destroy();
}
