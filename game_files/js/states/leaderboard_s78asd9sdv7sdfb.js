...
class Leaderboard extends Phaser.State {
  create() {
    ...
    if (!game.firebaseStarted) {
      // NOTE: Here you go: These credentials can be used to modify the
      // leaderboard entries. Access is unrestricted, so have fun. It's
      // not worth the hassel to obfuscate the code base again.
      var config = {
